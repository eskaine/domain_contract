...
contract Domains is ERC721URIStorage {
    ...
    constructor(string memory _tld) ERC721("Eskaine Domain Service", "EDS") payable {
    ...
    function register(string calldata name) public payable {
        ...
        // bytes32 finalTokenUri = bytes32( abi.encodePacked("data:application/json;base64,", json));
